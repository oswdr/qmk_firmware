:Ql/* Copyright 2020 Christopher Courtney, aka Drashna Jael're  (@drashna) <drashna@live.com>
 *
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_5x6_right(
     ...
     KC_LSFT, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                         KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,KC_RSFT,
                      RAISE,KC_LCTL,                                                       KC_LBRC, KC_RBRC,
                                    KC_LCTL, KC_BSPC,                                    KC_SPC,
                                      KC_LALT,KC_HOME,                                  KC_DEL,
  ...
  [_RAISE] = LAYOUT_5x6_right(
       ...
       _______,KC_ESC,_______,_______,_______,L_CURBR,                        R_CURBR,_______,KC_NLCK,KC_INS ,KC_SLCK,KC_MUTE,
